...
export class AACADTSParser {
  ...
  public readNextAACFrame(): AACFrame | null {
    ...
    while (aac_frame == null) {
      ...
      let next_syncword_offset = this.findNextSyncwordOffset(
      ...
      aac_frame.sampling_freq_index =
        sampling_frequency_index as MPEG4SamplingFrequencyIndex;
      aac_frame.sampling_frequency =
        MPEG4SamplingFrequencies[sampling_frequency_index];
    ...
    while (aac_frame == null) {
      ...
      if (!useSameStreamMux) {
        ...
        if (frameLengthType === 0) {
          ...
          Log.e(
            this.TAG,
            `frameLengthType = ${frameLengthType}. Only frameLengthType = 0 Supported`,
          );
          gb.destroy();
          break;
        }
        ...
        streamMuxConfig.sampling_frequency =
          MPEG4SamplingFrequencies[streamMuxConfig.sampling_freq_index];
      ...
      aac_frame.audio_object_type =
        streamMuxConfig.audio_object_type as MPEG4AudioObjectTypes;
      aac_frame.sampling_freq_index =
        streamMuxConfig.sampling_freq_index as MPEG4SamplingFrequencyIndex;
      aac_frame.sampling_frequency =
        MPEG4SamplingFrequencies[streamMuxConfig.sampling_freq_index];
