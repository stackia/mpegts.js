...
export class AC3Parser {
  ...
  public readNextAC3Frame(): AC3Frame | null {
    ...
    while (ac3_frame == null) {
      ...
      let frame_size =
        frame_size_code_table[sampling_rate_code][frame_size_code] * 2;
      ...
      let low_frequency_effects_channel_on =
...
export class EAC3Config {
  ...
  public constructor(frame: EAC3Frame) {
    ...
    const data_rate_sub = Math.floor(
      (frame.frame_size * frame.sampling_frequency) / (frame.num_blks * 16),
    );
