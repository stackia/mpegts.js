...
type OnAsynchronousKLVMetadataCallback = (
  asynchronous_klv_data: PESPrivateData,
) => void;
...
type OnPESPrivateDataDescriptorCallback = (
  private_data_descriptor: PESPrivateDataDescriptor,
) => void;
