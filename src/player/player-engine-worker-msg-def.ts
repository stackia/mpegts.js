...
export type WorkerMessagePacketPlayerEventError =
...
export type WorkerMessagePacketPlayerEventExtraData =
  WorkerMessagePacketPlayerEvent & {
    msg: "player_event";
    event:
...
export type WorkerMessagePacketTransmuxingEventInfo =
...
export type WorkerMessagePacketTransmuxingEventRecommendSeekpoint =
  WorkerMessagePacketTransmuxingEvent & {
    msg: "transmuxing_event";
