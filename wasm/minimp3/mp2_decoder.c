/*
 * MP2/MP3 Audio Decoder - WebAssembly Wrapper
 * 
 * This file provides a simple C interface for decoding MPEG Audio Layer 1/2/3
 * using minimp3, exported as WebAssembly functions.
 */
